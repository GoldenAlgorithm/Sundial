...
public class SundialAppSettings {
    ...
    public static const THEMES as Array<Dictionary<String, String or Number>> = [
        {
    ...
    public static function getIsInAirplaneMode() as Boolean {
    ...
    private static const PROPERTYID_THEME = "ThemeIndex";
